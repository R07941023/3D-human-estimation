...
parser = argparse.ArgumentParser(description='mayavi setting')

"----------------------------- General options -----------------------------"
parser.add_argument('--path', dest='path',
                    help='csv-name', default="")
parser.add_argument('--xrange', dest='xrange', nargs='+', default='',
                    help='the range of X axis for 3D plot')
parser.add_argument('--yrange', dest='yrange', nargs='+', default='',
                    help='the range of Y axis for 3D plot')
parser.add_argument('--zrange', dest='zrange', nargs='+', default='',
                    help='the range of Z axis for 3D plot')
parser.add_argument('--view', dest='view', nargs='+', default='',
                    help='the angle of the 3D view')
parser.add_argument('--record', default=False, type=bool,
                    help='record the frame to make a the video')
parser.add_argument('--video_path', dest='video_path',
                    help='video path', default="")
parser.add_argument('--UI', default=False, type=bool,
                    help='the UI on mayavi')
parser.add_argument('--fps', dest='fps', type=int,
                    help='fps', default='30')
parser.add_argument('--x_rotate', dest='x_rotate', type=int,
                    help='x_rotate', default=0)
parser.add_argument('--z_rotate', dest='z_rotate', type=int,
                    help='z_rotate', default=0)
parser.add_argument('--ball_velocity', dest='ball_velocity', type=str,
                    help='ball velocity', default='')
#
# "----------------------------- General options -----------------------------"
